"""D5R capacity matrix training, evaluation, and success evidence."""
...
def execute_d5r_capacity(
    ...
    *,
    ...
    return _finish_capacity_run(guard, source, profile, tuple(rows), gate, approved_name, approval_key)
