...
export const PROGRAM_PAGE_MATRIX = [
  { id: 'home', group: 'COMMAND', page: '홈', purpose: '전체 연구 판정과 다음 행동 확인', delivery: 'BUILT', evidenceState: 'DAILY_CLOSE_G2_SOURCE_HASH_BOUND_78', progress: 100, priority: 'P0', nextAction: 'G2 외부 권위 증거 4개 확보', eta: '화면 완료', mergeGate: '구현·경제·OOS 점수 분리 표시' },
  ...
  { id: 'rl-data', group: 'RL', page: '데이터', purpose: 'PIT·가용시각·수정주가·원천 관리', delivery: 'BUILT', evidenceState: 'G2_PARTIAL_1_PASS_4_EXTERNAL_BLOCKERS', progress: 100, priority: 'P0', nextAction: '날짜별 universe, available_at, 공식 가격, 기업행사 등록', eta: '외부 데이터 1~2일', mergeGate: '5개 관리 gate 모두 PASS' },
