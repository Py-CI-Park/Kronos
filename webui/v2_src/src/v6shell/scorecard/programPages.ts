...
export const PROGRAM_PAGE_MATRIX = [
  ...
  { id: 'rl-report', group: 'RL', page: '보고서', purpose: '판정·artifact·계보·다음 행동 전달', delivery: 'BUILT', evidenceState: 'AUDITED_LOCAL_ANCHOR_NO_GO_EXTERNAL_AUTHORITY', progress: 100, priority: 'P1', nextAction: '외부 수집 receipt를 기존 감사 receipt와 연결', eta: '화면 완료', mergeGate: 'Fresh OOS NOT_RUN_NO_READ 유지' },
