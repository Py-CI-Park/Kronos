...
export const PROGRAM_EXECUTION: ProgramExecution = {
  ...
  deliveryLane: 'codex/* at D2 research → research/* → v1.12 master integration → annotated D3 tag',
  baseRelease: 'fork-v1.11.0-kronos-rl-d2-historical-scale',
  releaseCandidate: 'fork-v1.13.0-kronos-rl-d3-representation-action',
  stage: 'D3_REPRESENTATION_ACTION_NOT_CONFIRMED',
  nextAction: 'D4 algorithm/objective ablation 사전등록',
  eta: '설계 2~4시간 / Smoke·Primary 4~8시간',
