...
export const PROGRAM_CAPABILITIES = [
  ...
  { id: 'daily-close-foundation', capability: '일봉 종가매매 G1~G6 연구 기반', state: 'PARTIAL', boundary: '구현 75/100, G2 관리 차단' },
  ...
  { id: 'point-in-time-custody', capability: 'PIT universe·available_at·수정주가·source hash', state: 'BLOCKED', boundary: 'G2 blocker 5개 미확보' },
