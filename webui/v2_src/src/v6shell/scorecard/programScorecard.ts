...
export const PROGRAM_SCORE_RUBRIC: Readonly<Record<ProgramLaneId, readonly ProgramScoreCriterion[]>> = {
  platform: [
    ...
    { id: 'd4-api', points: 20, achieved: true, evidence: 'D4·D5 읽기 전용 API와 tamper 차단' },
    { id: 'reviewed-snapshot', points: 20, achieved: true, evidence: 'D5 10-model custody snapshot' },
  ...
  'rl-evidence': [
    ...
    { id: 'negative-control', points: 18, achieved: true, evidence: 'D5 NATIVE 대 SHUFFLED, 각 5 seeds' },
    ...
    { id: 'cost-diagnostic', points: 12, achieved: true, evidence: 'D5 23bp 직접 학습·Primary, 0bp 진단' },
    { id: 'confirmed-rl-arm', points: 15, achieved: true, evidence: 'D4 DQN train-only 확인 보존; D5 확장 gate는 NOT_CONFIRMED' },
  ...
  engineering: [
    ...
    { id: 'matrix-identity', points: 15, achieved: true, evidence: 'D4 24-unit·D5 10-unit exact matrix' },
...
export const PROGRAM_PAGE_MATRIX = [
  ...
  { id: 'scorecard', group: 'COMMAND', page: 'Program Scorecard', purpose: '점수와 페이지 감사', delivery: 'BUILT', evidenceState: 'D5_AUDITED_86', progress: 100, priority: 'P1', nextAction: 'D5 release 계보 반영', eta: '완료', mergeGate: '가중치 100%' },
  ...
  { id: 'rl-data', group: 'RL', page: 'Data', purpose: 'split·비용·Fresh OOS 경계', delivery: 'BUILT', evidenceState: 'FULL_TRAIN_573_BOUND', progress: 100, priority: 'P0', nextAction: 'D5R 입력 재사용 동결', eta: '완료', mergeGate: 'input SHA 고정' },
  { id: 'rl-experiment', group: 'RL', page: 'Experiment', purpose: '가설·arm·seed·gate 사전등록', delivery: 'BUILT', evidenceState: 'D5_PREREG_EXECUTED', progress: 100, priority: 'P0', nextAction: 'D5R prereg', eta: '2~4시간', mergeGate: '실행 전 SHA 고정' },
...
export const PROGRAM_CAPABILITIES = [
  ...
  { id: 'd5-d6', capability: 'D5R~D6 연구 사다리', state: 'PARTIAL', boundary: 'D5R 통과 전 reused validation 봉인' },
