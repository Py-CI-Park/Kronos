...
export const PROGRAM_PAGE_MATRIX = [
  ...
  { id: 'rl-discovery', group: 'RL', page: 'Discovery Lab', purpose: 'D0~D6 연구 질문과 arm 귀속성', delivery: 'BUILT', evidenceState: 'D1_PRIMARY_COMPLETE', progress: 98, priority: 'P0', nextAction: 'D2 episode scale 사전등록', eta: '설계 2~4시간', mergeGate: '9/9 + terminal receipt + custody' },
