...
export const PROGRAM_LANES = [
  { id: 'platform', label: 'Platform', labelKo: '플랫폼·UX', score: programRubricScore('platform'), weight: 30, state: 'STRONG', evidence: '8개 통합 페이지, 공통 셸, 반응형 UI, 실제 브라우저 검수', nextAction: '원격 PR·릴리스 증거를 연결합니다.' },
