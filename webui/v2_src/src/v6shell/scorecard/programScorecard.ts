...
export const PROGRAM_PAGE_MATRIX = [
  { id: 'home', group: 'COMMAND', page: 'Home', purpose: '전체 연구 상태와 안전 경계', delivery: 'BUILT', evidenceState: 'D5_NOT_CONFIRMED_VISIBLE', progress: 100, priority: 'P1', nextAction: 'D5R 질문 연결', eta: '완료', mergeGate: '판정·증거 일치' },
  ...
  { id: 'rl-discovery', group: 'RL', page: 'Discovery Lab', purpose: 'D0~D7 질문과 arm 귀속성', delivery: 'BUILT', evidenceState: 'D5_PRIMARY_10_OF_10', progress: 100, priority: 'P0', nextAction: 'D5R capacity/objective', eta: '완료', mergeGate: '10/10+receipt+control' },
  ...
  { id: 'rl-training', group: 'RL', page: 'Training', purpose: '학습·모델·resume 상태', delivery: 'BUILT', evidenceState: 'D5_PRIMARY_10_OF_10', progress: 100, priority: 'P1', nextAction: 'D5R Smoke→Primary', eta: '6~12시간', mergeGate: 'algorithm·reward·seed 보존' },
  { id: 'rl-evaluation', group: 'RL', page: 'Evaluation', purpose: '비용·상한·negative control', delivery: 'BUILT', evidenceState: 'D5_FULL_TRAIN_COST_NOT_CONFIRMED', progress: 100, priority: 'P0', nextAction: 'accuracy/reward 분해', eta: '2~4시간', mergeGate: 'fit/native/23bp 분리' },
