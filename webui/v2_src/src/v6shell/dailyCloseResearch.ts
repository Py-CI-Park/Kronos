...
export const DAILY_CLOSE_RESEARCH = {
  ...
  sourceCustody: {
    databaseHashState: 'SHA256_BOUND', passedGateCount: 1, totalGateCount: 5,
    externalBlockerCount: 4, priceBasisStatus: 'UNKNOWN_CONFIRMED', readOnly: true,
  },
  gates: [
    { id: 'G1', label: '비용 계약', purpose: '주식·ETF 비용 분리', state: 'COMPLETE', score: 15, maximumScore: 15, result: 'KRX 주식 왕복 0.230%' },
    { id: 'G2', label: '데이터 관리', purpose: 'PIT·가용시각·수정주가', state: 'BLOCKED', score: 3, maximumScore: 15, result: '원천 SHA 통과 · 외부 권위 4개 차단' },
  ...
  blockers: ['POINT_IN_TIME_UNIVERSE', 'AVAILABLE_AT_PROVEN', 'OFFICIAL_PRICE_IDENTITY', 'CORPORATE_ACTION_CONTRACT'],
  nextAction: '시점별 종목군·가용시각·공식 가격 정체성·기업행사 정책을 권위 자료로 등록한 뒤 같은 G3를 재실행합니다.',
} as const;
