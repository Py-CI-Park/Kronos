...
export const TelemetryPointSchema = z.object({
  ...
  decision_timestamp: z.string().min(1).nullable().default(null),
  reward_observed_at: z.string().min(1).nullable().default(null),
  ...
  telemetry_live_stream: z.boolean().nullable().default(null),
  telemetry_producer_state: z.string().min(1).nullable().default(null),
}).readonly();
