...
<style>
  .page { max-width: 980px; color: #e5e7eb; } header, .card, .panel { border: 1px solid #334155; border-radius: 14px; padding: clamp(16px, 4vw, 28px); background: #111827; } .eyebrow { margin: 0; color: #7dd3fc; font-size: .72rem; font-weight: 800; letter-spacing: .1em; } h1 { margin: 7px 0; color: #f8fafc; font-size: clamp(1.7rem, 6vw, 2.5rem); } header > p:last-child, .chart-head p { color: #cbd5e1; } .lookup { display: flex; flex-wrap: wrap; align-items: end; gap: 8px; margin: 16px 0; } label { display: grid; gap: 5px; color: #cbd5e1; font-size: .82rem; } input { width: 8rem; border: 1px solid #475569; border-radius: 6px; padding: 8px; background: #020617; color: #f8fafc; font: inherit; } button { border: 1px solid #7dd3fc; border-radius: 6px; padding: 8px 12px; background: transparent; color: #e0f2fe; font: inherit; cursor: pointer; } small { color: #94a3b8; }.card, .panel { margin-top: 16px; } .chart-head { display: flex; justify-content: space-between; gap: 12px; align-items: start; } h2 { margin: 0; color: #f8fafc; font-size: 1.1rem; } .chart-head p { margin: 5px 0 0; } .chip { border: 1px solid #a16207; border-radius: 999px; padding: 3px 7px; color: #fde68a; font-size: .72rem; } svg { width: 100%; height: 360px; margin-top: 14px; background: #020617; } .pane { fill: #0f172a; stroke: #334155; } .zero { stroke: #475569; stroke-dasharray: 5 5; } polyline { fill: none; stroke-width: 3; vector-effect: non-scaling-stroke; } .close { stroke: #38bdf8; } .foreign { stroke: #a78bfa; } line.positive { stroke: #34d399; } line.negative { stroke: #fb7185; } text { fill: #94a3b8; font-size: 19px; } .dates, .legend { display: flex; justify-content: space-between; gap: 12px; color: #94a3b8; font-size: .78rem; overflow-wrap: anywhere; } .legend { justify-content: start; align-items: center; flex-wrap: wrap; } .line { width: 16px; border-top: 3px solid; } .close-key { border-color: #38bdf8; } .foreign-key { border-color: #a78bfa; } .bar-key { width: 3px; height: 12px; background: #34d399; } .caveats { margin-top: 12px; border-top: 1px solid #475569; color: #fde68a; font-size: .83rem; overflow-wrap: anywhere; } .error { border-color: #b91c1c; color: #fecaca; } .empty { border-color: #a16207; background: #1c1910; } @media (max-width: 390px) { svg { height: 300px; } .lookup small { width: 100%; } }
</style>
