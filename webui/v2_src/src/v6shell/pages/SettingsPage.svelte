...
<section class="page" aria-labelledby="settings-title">
  ...
  <div class="cards">
    ...
    <section class="card" aria-labelledby="shell-title"><h2 id="shell-title">Shell 안내</h2><p>V3가 기본 대시보드입니다. V6는 연구 워크플로를 분리해 살펴보는 읽기 전용 레인입니다.</p><div class="shell-links"><a href="/">V3 기본</a><a href="/?ui=v5">V5.1 연구 뷰어</a></div></section>
