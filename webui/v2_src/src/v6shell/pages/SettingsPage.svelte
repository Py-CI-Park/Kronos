...
<style>
  ...
  @media (max-width: 360px) { header, .card { padding: 16px; } .choices, .shell-links { display: grid; grid-template-columns: 1fr; } .choices button, .shell-links a, .wide { width: 100%; } }
</style>
