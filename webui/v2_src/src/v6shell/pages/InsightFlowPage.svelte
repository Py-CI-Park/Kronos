...
<style>
  .page { max-width: 1100px; color: var(--fg); } header, .panel, .ranking { border: 1px solid var(--border); border-radius: 14px; padding: clamp(16px, 4vw, 28px); background: var(--surface); } .eyebrow { margin: 0; color: var(--accent); font-size: .72rem; font-weight: 800; letter-spacing: .1em; } h1 { margin: 7px 0; color: var(--fg-strong); font-size: clamp(1.7rem, 6vw, 2.5rem); } h2 { margin: 0 0 12px; color: var(--fg-strong); font-size: 1.05rem; } header > p:last-child { color: var(--muted); } .banner { display: inline-block; margin: 8px 0; border: 1px solid var(--warn); border-radius: 7px; padding: 8px 10px; background: var(--warn-soft); color: var(--warn); font-weight: 800; }.controls { display: flex; flex-wrap: wrap; align-items: end; gap: 8px; margin: 16px 0; } label { display: grid; gap: 5px; color: var(--muted); font-size: .82rem; } select, button { border: 1px solid var(--border-strong); border-radius: 6px; padding: 8px; background: var(--surface-sunken); color: var(--fg-strong); font: inherit; } button { border-color: var(--accent); color: var(--accent-strong); cursor: pointer; } .panel { margin-top: 16px; } .note { border-left: 3px solid var(--accent); padding-left: 10px; color: var(--muted); overflow-wrap: anywhere; } .caveats { margin: 12px 0; border-left: 3px solid var(--warn); padding-left: 10px; color: var(--warn); font-size: .83rem; overflow-wrap: anywhere; } .grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 14px; } .ranking { min-width: 0; } .table-wrap { max-width: 100%; overflow-x: auto; } table { width: 100%; border-collapse: collapse; font-size: .78rem; } th, td { border-top: 1px solid var(--border); padding: 7px; text-align: left; overflow-wrap: anywhere; } th { color: var(--muted); } .missing { color: var(--muted); } .error { border-color: var(--danger); color: var(--danger); } .empty { border-color: var(--warn); background: var(--warn-soft); } @media (max-width: 700px) { .grid { grid-template-columns: 1fr; } } @media (max-width: 390px) { th, td { padding: 6px 4px; font-size: .7rem; } }
</style>
