...
<style>
  .evaluation-page, .panel { max-width: 980px; border: 1px solid var(--surface-border, #334155); border-radius: 14px; padding: clamp(18px, 4vw, 32px); background: var(--surface, #111827); color: #e5e7eb; } .eyebrow { margin: 0; color: #7dd3fc; font-size: .72rem; font-weight: 800; letter-spacing: .1em; } h1 { margin: 7px 0; color: #f8fafc; font-size: clamp(1.7rem, 6vw, 2.5rem); } header > p, .absence { color: #94a3b8; } .card, .empty-state { margin-top: 16px; border: 1px solid #475569; border-radius: 10px; padding: 16px; background: #0f172a; } .empty-state { border-color: #a16207; background: #1c1910; } h2 { margin: 0 0 12px; color: #f8fafc; font-size: 1.05rem; } h3 { margin: 18px 0 8px; color: #bae6fd; font-size: .9rem; } .run-list { display: grid; gap: 7px; } .run-list button { width: 100%; display: flex; justify-content: space-between; gap: 8px; border: 1px solid #475569; border-radius: 6px; padding: 8px; background: #020617; color: #e2e8f0; font: inherit; text-align: left; cursor: pointer; overflow-wrap: anywhere; } .run-list button.chosen { border-color: #38bdf8; } .chip { display: inline-block; margin-left: 5px; border: 1px solid currentColor; border-radius: 999px; padding: 2px 6px; font-size: .68rem; vertical-align: middle; } .verdict.no-go { border-color: #dc2626; background: #2b1015; color: #fecaca; } .verdict.candidate { border-color: #d97706; background: #2b1d0b; color: #fde68a; } .verdict.inconclusive { border-color: #64748b; color: #cbd5e1; } .table-wrap { max-width: 100%; overflow-x: auto; } table { width: 100%; min-width: 580px; border-collapse: collapse; font-size: .78rem; } th, td { border-top: 1px solid #334155; padding: 7px; overflow-wrap: anywhere; text-align: left; } th { color: #94a3b8; } .error { border-color: #b91c1c; color: #fecaca; } button { border: 1px solid #7dd3fc; border-radius: 6px; padding: 6px 10px; background: transparent; color: #e0f2fe; font: inherit; cursor: pointer; } li { overflow-wrap: anywhere; }
</style>
