...
<style>
  .page { max-width: 980px; color: #e5e7eb; } header, .panel, .card, .verdict { border: 1px solid #334155; border-radius: 14px; padding: clamp(16px, 4vw, 28px); background: #111827; } .eyebrow { margin: 0; color: #7dd3fc; font-size: .72rem; font-weight: 800; letter-spacing: .1em; } h1 { margin: 7px 0; color: #f8fafc; font-size: clamp(1.7rem, 6vw, 2.5rem); } h2 { margin: 0 0 12px; color: #f8fafc; font-size: 1.1rem; } header > p:last-child { color: #cbd5e1; } .verdict, .card, .panel { margin-top: 16px; } .verdict h2 { color: #67e8f9; font-size: clamp(2rem, 8vw, 3.5rem); }.verdict.danger { border-color: #b91c1c; background: #240b12; } .verdict.danger h2 { color: #fca5a5; } ul { margin: 0; padding-left: 20px; } li + li { margin-top: 6px; } .table-wrap { max-width: 100%; overflow-x: auto; } table { width: 100%; min-width: 680px; border-collapse: collapse; font-size: .82rem; } th, td { border-top: 1px solid #334155; padding: 9px; text-align: left; vertical-align: top; overflow-wrap: anywhere; } th { color: #94a3b8; } code { overflow-wrap: anywhere; color: #bae6fd; } .rules { border-color: #a16207; background: #1c1910; color: #fde68a; } .docs { list-style: none; padding: 0; } .docs li { border-top: 1px solid #334155; padding: 8px 0; } .error { border-color: #b91c1c; color: #fecaca; } .empty { border-color: #a16207; background: #1c1910; } button { border: 1px solid #7dd3fc; border-radius: 6px; padding: 8px 12px; background: transparent; color: #e0f2fe; font: inherit; cursor: pointer; }
</style>
