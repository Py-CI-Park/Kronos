...
<style>
  .page { max-width: 980px; color: #e5e7eb; } header, .panel, .card { border: 1px solid #334155; border-radius: 14px; padding: clamp(16px, 4vw, 28px); background: #111827; } .eyebrow { margin: 0; color: #7dd3fc; font-size: .72rem; font-weight: 800; letter-spacing: .1em; } h1 { margin: 7px 0; color: #f8fafc; font-size: clamp(1.7rem, 6vw, 2.5rem); } h2 { margin: 0 0 12px; color: #f8fafc; font-size: 1.1rem; } header > p:last-child { color: #cbd5e1; } .panel { margin-top: 16px; } .cards { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 16px; margin-top: 16px; } .card { min-width: 0; } .blocked { border-color: #b91c1c; background: #240b12; } .state { margin: 0 0 8px; color: #fca5a5; font-size: .74rem; font-weight: 900; letter-spacing: .1em; } .breadth .state { color: #7dd3fc; } .command-label { margin: 18px 0 6px; color: #fecaca; font-size: .78rem; font-weight: 800; } code { display: block; overflow-wrap: anywhere; border: 1px solid #7f1d1d; padding: 10px; background: #020617; color: #fecaca; font-size: .78rem; } .big { margin: 12px 0; color: #67e8f9; font-size: clamp(2.4rem, 9vw, 4.5rem); font-weight: 900; } dl { display: grid; grid-template-columns: auto 1fr; gap: 7px 16px; border-top: 1px solid #334155; padding-top: 12px; } dt { color: #94a3b8; } dd { margin: 0; overflow-wrap: anywhere; } .disclaimer { border-top: 1px solid #475569; padding-top: 12px; color: #fde68a; font-size: .83rem; overflow-wrap: anywhere; } .error { border-color: #b91c1c; color: #fecaca; } button { border: 1px solid #7dd3fc; border-radius: 6px; padding: 8px 12px; background: transparent; color: #e0f2fe; font: inherit; cursor: pointer; } @media (max-width: 650px) { .cards { grid-template-columns: 1fr; } }
</style>
