...
def load_trading_command_workflow() -> dict[str, Any]:
    return {
        ...
        "labels": list(RESEARCH_LABELS),
        "process_map": [
            {"step": "D0", "name": "데이터·증거 발견", "status": "STALE", "allowed": True},
            {"step": "D1", "name": "룰 기준선 비교", "status": "NO_GO", "allowed": True},
            {"step": "D2", "name": "23bp 비용 게이트", "status": "NO_GO", "allowed": True},
            {"step": "D3", "name": "낙폭 검토", "status": "MISSING", "allowed": True},
            {"step": "D4", "name": "거래 수·회전율 검토", "status": "STALE", "allowed": True},
            {"step": "D5", "name": "음성/셔플 통제", "status": "MISSING", "allowed": True},
            {"step": "D6", "name": "OOS 분리 검토", "status": "MISSING", "allowed": True},
            {"step": "D7", "name": "감사 증거 묶음", "status": "MALFORMED", "allowed": True},
            {"step": "D8", "name": "사람 연구 검토", "status": "NOT_STARTED", "allowed": True},
            {"step": "D9", "name": "거래 준비 판정", "status": "NO_GO", "allowed": False},
        ],
