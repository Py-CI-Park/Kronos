...
| ridge 증분(모델−룰) | **−1.176%/trade**, CI [−1.78, −0.64] (0 제외, 음수), Sharpe −0.33 |
| gbm 증분 | **−0.560%/trade**, CI [−1.12, −0.087] (0 제외, 음수), Sharpe −0.20 |
| per-boundary 증분 | ridge −0.97~−1.28 / gbm −0.52~−0.69 (전 5경계 음수) |
| **VERDICT** | **NO-GO** |
