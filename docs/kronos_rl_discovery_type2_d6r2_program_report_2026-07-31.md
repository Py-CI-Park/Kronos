...
| Git 브랜치·PR·태그 | 100% | 100 | 완료 | PR #27→research, PR #28→master, v1.20.0 tag |
...
| PR·merge·tag 정리 | 완료 | PR #27·#28 merge, `fork-v1.20.0-kronos-rl-d6r2-mdp-falsification` |
...
모델 성과 18/100 상태에서 동일 top-5/14-feature RL을 반복하는 것은 중단한다. 새로운 feature/horizon의 저비용 signal floor와 stateful MDP 합성 learnability를 먼저 통과하는 경우에만 실제 데이터 RL pilot을 허용한다. 상세 근거·단계별 kill gate·예산은 [`kronos_rl_continuation_decision_review_2026-07-31.md`](kronos_rl_continuation_decision_review_2026-07-31.md)에 기록했다.
